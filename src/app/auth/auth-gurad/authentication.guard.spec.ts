...
describe('AuthenticationGuard', () => {
  ...
  it('should return true if Customer is authenticated', () => {
    expect(authenticationGuard.canActivate(new ActivatedRouteSnapshot(), mockSnapshot)).toBe(true);
  });

  it('should return false and redirect to login if Customer is not authenticated', () => {
    // Arrange
  ...
  it('should save url as queryParam if Customer is not authenticated', () => {
    credentialsService.credentials = null;
